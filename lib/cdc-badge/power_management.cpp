...
void IRAM_ATTR powerButtonInterruptHandler() { powerButtonInterruptOccurred = true; }
...
bool power_management_init() {
    ...
    attachInterrupt(digitalPinToInterrupt(FLASH_BTN_PIN), powerButtonInterruptHandler, FALLING);
